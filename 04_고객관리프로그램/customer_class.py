...
class Customer:
    ...
    def __init__(self):
        self.custlist= [{'name': 'hong1', 'gender' : 'M', 'email': 'hong1@gmail.com', 'birthyear' : '2002'},
                        {'name': 'hong2', 'gender' : 'M', 'email': 'hong2@gmail.com', 'birthyear' : '2002'},
                        {'name': 'hong3', 'gender' : 'M', 'email': 'hong3@gmail.com', 'birthyear' : '2002'},
                        {'name': 'hong4', 'gender' : 'M', 'email': 'hong4@gmail.com', 'birthyear' : '2002'}]
        self.page=3
        while True:
